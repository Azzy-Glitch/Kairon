...
/// see UserAgentOptions.AgentKey). An explicitly configured non-default key is honored unchanged
...
///
/// Duplicated from agent/Kairon.Agent/AgentCredentialStore.cs (same reasoning as
