...
Use `KaironClient.pair(endpoint, pairing_code)` to exchange a temporary code generated by KAIRON.
It returns the scoped configuration once; invalid, expired, reused, and revoked codes are rejected.
