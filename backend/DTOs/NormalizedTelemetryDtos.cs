...
/// <summary>
/// Wire contracts for the normalized telemetry pipeline (docs/DESKTOP_SHELL.md) - adapted from
/// Azzy's productization branch, unchanged in shape. This is new, additive capability alongside
/// TelemetryController's existing /api/telemetry/* routes, not a replacement for them.
/// </summary>
