...
/// <summary>
/// The SDK's core promise (PRD section 17): "The SDK must not turn an Kairon outage into an
...
public class TelemetryClientTests
{
        ...
        Action<KaironOptions>? configure = null)
    {
        ...
        return new KaironTelemetryClient(http, Options.Create(options));
    }
    ...
    {
        // The headline case: Kairon is down and the host application must not notice.
